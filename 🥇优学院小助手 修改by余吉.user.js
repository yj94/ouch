...
function Init() {
    ...
    if(pageurl=="https://utest.ulearning.cn/"){
        div.setAttribute("style", "background-color: #C6DFF7; position: fixed; top: 54px; left: 380px; width: 270px; opacity: 0.03;border-style: dotted; border-width: 3px;z-index:99999;");
    }
    else{
